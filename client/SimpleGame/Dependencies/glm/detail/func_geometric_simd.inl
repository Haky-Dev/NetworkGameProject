...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER static float call(tvec4<float, P> const& m_x, tvec4<float, P> const& m_y)
		{
			return _mm_cvtss_f32(glm_vec1_dot(m_x.data, m_y.data));
		}
	};
	...
	struct compute_cross<float, P, true>
	{
		...
		{
			__m128 const set0 = _mm_set_ps(0.0f, a.z, a.m_y, a.m_x);
			__m128 const set1 = _mm_set_ps(0.0f, b.z, b.m_y, b.m_x);
