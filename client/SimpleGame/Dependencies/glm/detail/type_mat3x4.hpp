...
namespace glm
{
	...
	public:
		...
		GLM_FUNC_DECL GLM_EXPLICIT tmat3x4(tmat2x2<T, P> const & m_x);
		GLM_FUNC_DECL GLM_EXPLICIT tmat3x4(tmat3x3<T, P> const & m_x);
		GLM_FUNC_DECL GLM_EXPLICIT tmat3x4(tmat4x4<T, P> const & m_x);
		GLM_FUNC_DECL GLM_EXPLICIT tmat3x4(tmat2x3<T, P> const & m_x);
		GLM_FUNC_DECL GLM_EXPLICIT tmat3x4(tmat3x2<T, P> const & m_x);
		GLM_FUNC_DECL GLM_EXPLICIT tmat3x4(tmat2x4<T, P> const & m_x);
		GLM_FUNC_DECL GLM_EXPLICIT tmat3x4(tmat4x2<T, P> const & m_x);
		GLM_FUNC_DECL GLM_EXPLICIT tmat3x4(tmat4x3<T, P> const & m_x);
