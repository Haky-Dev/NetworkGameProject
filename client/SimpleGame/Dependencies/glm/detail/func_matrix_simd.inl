...
namespace detail
{
	...
	struct compute_matrixCompMult<tmat4x4, float, P, true>
	{
		...
		GLM_FUNC_QUALIFIER static tmat4x4<float, P> call(tmat4x4<float, P> const & m_x, tmat4x4<float, P> const & m_y)
		{
			tmat4x4<float, P> result(uninitialize);
			glm_mat4_matrixCompMult(
				*(glm_vec4 const (*)[4])&m_x[0].data,
				*(glm_vec4 const (*)[4])&m_y[0].data,
