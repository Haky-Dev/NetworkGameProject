...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
		...
		typename tmat4x3<T, P>::row_type const & v)
	{
		return typename tmat4x3<T, P>::col_type(
			m[0][0] * v.m_x + m[1][0] * v.m_y + m[2][0] * v.z + m[3][0] * v.w,
			m[0][1] * v.m_x + m[1][1] * v.m_y + m[2][1] * v.z + m[3][1] * v.w,
			m[0][2] * v.m_x + m[1][2] * v.m_y + m[2][2] * v.z + m[3][2] * v.w);
	}
		...
		tmat4x3<T, P> const & m)
	{
		return typename tmat4x3<T, P>::row_type(
			v.m_x * m[0][0] + v.m_y * m[0][1] + v.z * m[0][2],
			v.m_x * m[1][0] + v.m_y * m[1][1] + v.z * m[1][2],
			v.m_x * m[2][0] + v.m_y * m[2][1] + v.z * m[2][2],
			v.m_x * m[3][0] + v.m_y * m[3][1] + v.z * m[3][2]);
	}
