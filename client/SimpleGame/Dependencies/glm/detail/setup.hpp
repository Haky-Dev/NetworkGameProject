...
#	define GLM_STATIC_ASSERT(m_x, message) static_assert(m_x, message)
...
#	define GLM_ALIGN(m_x) __declspec(align(m_x))
#	define GLM_ALIGNED_STRUCT(m_x) struct __declspec(align(m_x))
...
#	define GLM_ALIGN(m_x) __attribute__((aligned(m_x)))
#	define GLM_ALIGNED_STRUCT(m_x) struct __attribute__((aligned(m_x)))
...
#	define GLM_ALIGN(m_x) __align__(m_x)
#	define GLM_ALIGNED_STRUCT(m_x) struct __align__(m_x)
#	define GLM_ALIGNED_TYPEDEF(type, name, alignment) typedef type name __align__(m_x)
#	define GLM_RESTRICT_FUNC __restrict__
#	define GLM_RESTRICT __restrict__
#	define GLM_VECTOR_CALL
#else
#	define GLM_DEPRECATED
#	define GLM_ALIGN
#	define GLM_ALIGNED_STRUCT(m_x) struct
