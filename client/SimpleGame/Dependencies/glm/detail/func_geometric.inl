...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER static T call(tvec2<T, P> const & m_x, tvec2<T, P> const & m_y)
		{
			tvec2<T, P> tmp(m_x * m_y);
			return tmp.m_x + tmp.m_y;
		}
	};
	...
	{
		GLM_FUNC_QUALIFIER static T call(tvec3<T, P> const & m_x, tvec3<T, P> const & m_y)
		{
			tvec3<T, P> tmp(m_x * m_y);
			return tmp.m_x + tmp.m_y + tmp.z;
		}
	};
	...
	{
		GLM_FUNC_QUALIFIER static T call(tvec4<T, P> const & m_x, tvec4<T, P> const & m_y)
		{
			tvec4<T, P> tmp(m_x * m_y);
	...
	{
		GLM_FUNC_QUALIFIER static tvec3<T, P> call(tvec3<T, P> const & m_x, tvec3<T, P> const & m_y)
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559, "'cross' accepts only floating-point inputs");

			return tvec3<T, P>(
				m_x.m_y * m_y.z - m_y.m_y * m_x.z,
				m_x.z * m_y.m_x - m_y.z * m_x.m_x,
				m_x.m_x * m_y.m_y - m_y.m_x * m_x.m_y);
		}
	};
	...
	GLM_FUNC_QUALIFIER genType length(genType m_x)
	{
	...
	// dot
	template <typename T>
	GLM_FUNC_QUALIFIER T dot(T m_x, T m_y)
	{
	...
	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER T dot(vecType<T, P> const & m_x, vecType<T, P> const & m_y)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559, "'dot' accepts only floating-point inputs");
		return detail::compute_dot<vecType, T, P, detail::is_aligned<P>::value>::call(m_x, m_y);
	}

	// cross
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER tvec3<T, P> cross(tvec3<T, P> const & m_x, tvec3<T, P> const & m_y)
	{
		return detail::compute_cross<T, P, detail::is_aligned<P>::value>::call(m_x, m_y);
	}

	// normalize
	template <typename genType>
	GLM_FUNC_QUALIFIER genType normalize(genType const & m_x)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genType>::is_iec559, "'normalize' accepts only floating-point inputs");

		return m_x < genType(0) ? genType(-1) : genType(1);
	}

	template <typename T, precision P, template <typename, precision> class vecType>
	GLM_FUNC_QUALIFIER vecType<T, P> normalize(vecType<T, P> const & m_x)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559, "'normalize' accepts only floating-point inputs");

		return detail::compute_normalize<T, P, vecType, detail::is_aligned<P>::value>::call(m_x);
	}
