...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER static tvec4<float, P> call(tvec4<float, P> const & m_x, tvec4<float, P> const & m_y)
		{
			tvec4<float, P> result(uninitialize);
			result.data = glm_vec4_mod(m_x.data, m_y.data);
			return result;
		}
	};
	...
	{
		GLM_FUNC_QUALIFIER static tvec4<float, P> call(tvec4<float, P> const & m_x, tvec4<float, P> const & minVal, tvec4<float, P> const & maxVal)
		{
			tvec4<float, P> result(uninitialize);
			result.data = _mm_min_ps(_mm_max_ps(m_x.data, minVal.data), maxVal.data);
			return result;
		}
	};
	...
	{
		GLM_FUNC_QUALIFIER static tvec4<int32, P> call(tvec4<int32, P> const & m_x, tvec4<int32, P> const & minVal, tvec4<int32, P> const & maxVal)
		{
			tvec4<int32, P> result(uninitialize);
			result.data = _mm_min_epi32(_mm_max_epi32(m_x.data, minVal.data), maxVal.data);
			return result;
		}
	};
	...
	{
		GLM_FUNC_QUALIFIER static tvec4<uint32, P> call(tvec4<uint32, P> const & m_x, tvec4<uint32, P> const & minVal, tvec4<uint32, P> const & maxVal)
		{
			tvec4<uint32, P> result(uninitialize);
			result.data = _mm_min_epu32(_mm_max_epu32(m_x.data, minVal.data), maxVal.data);
			return result;
		}
	};
	...
	{
		GLM_FUNC_QUALIFIER static tvec4<float, P> call(tvec4<float, P> const & m_x, tvec4<float, P> const & m_y, tvec4<bool, P> const & a)
		{
			__m128i const Load = _mm_set_epi32(-(int)a.w, -(int)a.z, -(int)a.m_y, -(int)a.m_x);
...
#			else
				Result.data = _mm_or_ps(_mm_and_ps(Mask, m_y.data), _mm_andnot_ps(Mask, m_x.data));
#			endif
			return Result;
		}
	};
...
*/
	...
	{
		GLM_FUNC_QUALIFIER static tvec4<float, P> call(tvec4<float, P> const& edge0, tvec4<float, P> const& edge1, tvec4<float, P> const& m_x)
		{
			tvec4<float, P> result(uninitialize);
			result.data = glm_vec4_smoothstep(edge0.data, edge1.data, m_x.data);
			return result;
		}
	};
}//namespace detail
