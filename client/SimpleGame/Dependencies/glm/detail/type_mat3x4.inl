...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
	...
	)
	{
		return typename tmat3x4<T, P>::col_type(
			m[0][0] * v.m_x + m[1][0] * v.m_y + m[2][0] * v.z,
			m[0][1] * v.m_x + m[1][1] * v.m_y + m[2][1] * v.z,
			m[0][2] * v.m_x + m[1][2] * v.m_y + m[2][2] * v.z,
			m[0][3] * v.m_x + m[1][3] * v.m_y + m[2][3] * v.z);
	}
	...
	)
	{
		return typename tmat3x4<T, P>::row_type(
			v.m_x * m[0][0] + v.m_y * m[0][1] + v.z * m[0][2] + v.w * m[0][3],
			v.m_x * m[1][0] + v.m_y * m[1][1] + v.z * m[1][2] + v.w * m[1][3],
			v.m_x * m[2][0] + v.m_y * m[2][1] + v.z * m[2][2] + v.w * m[2][3]);
	}
