...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER static matType<T, P> call(matType<T, P> const& m_x, matType<T, P> const& m_y)
		{
	...
	struct compute_inverse<tmat4x4, T, P, Aligned>
	{
		GLM_FUNC_QUALIFIER static tmat4x4<T, P> call(tmat4x4<T, P> const& m)
		{
			...
			T Dot1 = (Dot0.m_x + Dot0.m_y) + (Dot0.z + Dot0.w);
	...
	GLM_FUNC_QUALIFIER matType<T, P> matrixCompMult(matType<T, P> const & m_x, matType<T, P> const & m_y)
	{
		...
		return detail::compute_matrixCompMult<matType, T, P, detail::is_aligned<P>::value>::call(m_x, m_y);
	}
